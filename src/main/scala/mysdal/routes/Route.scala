...
case class Route(path: String, expression: String, shards: Set[Shard], var prefix: String, loadBalanceStrategy: LoadBalanceStrategy = new AlwaysFirstReplicaLoadBalanceStrategy, expressionEngine: ExpressionEngine = new MVELExpressionEngine)
